...
// 下载时间
@property (nonatomic, strong) NSData *downloadDate;
// 断点续传需要设置这个数据
...
-(NSString *)downloadDirectory{
    if (!_downloadDirectory) {
        _downloadDirectory = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"DownLoadCaches"];
    }
