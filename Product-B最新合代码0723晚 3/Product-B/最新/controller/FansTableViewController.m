...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[FansAndConcernTableViewCell class] forCellReuseIdentifier:@"999"];
}

- (void)requestData
{
    NSString *str = [NSString stringWithFormat:@"&userid=%@&ver=4.3",self.idString];
    NSString *str1 = @"http://api.budejie.com/api/api_open.php?a=fans_list&appname=bs0315&asid=521E371B-3293-45BE-A6A9-2FA802FC3FB3&c=user&client=iphone&device=ios%20device&follow_id=0&from=ios&jbk=0&mac=&market=&openudid=6ad14d71d2c90eb5b9fabef86257c6e53b35e5ca&sex=m&udid=";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FansAndConcernTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"999" forIndexPath:indexPath];
