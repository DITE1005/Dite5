...
@interface TotalCupTableViewController ()
...
@implementation TotalCupTableViewController
...
- (void)viewDidLoad {
    ...
    self.limitIndex = 1;
    self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/user/contribution_rank/alltime/%ld.json",self.limitIndex * 40];
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/user/contribution_rank/alltime/%ld.json",(self.limitIndex + 1) * 40];
        self.limitIndex += 1;
        [self.modelArray removeAllObjects];
