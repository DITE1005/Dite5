...
@interface NowCupTableViewController ()
...
@implementation NowCupTableViewController
...
- (void)viewDidLoad {
    ...
    self.limitIndex = 1;
    self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/user/contribution_rank/current_month/%ld.json",self.limitIndex * 40];
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/user/contribution_rank/current_month/%ld.json",(self.limitIndex + 1) * 40];
        self.limitIndex += 1;
        [self.modelArray removeAllObjects];
