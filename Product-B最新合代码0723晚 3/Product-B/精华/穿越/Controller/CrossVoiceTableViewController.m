//
//  CrossVoiceTableViewController.m
//  Product-B
//
...
@interface CrossVoiceTableViewController ()
...
@implementation CrossVoiceTableViewController
...
- (void)viewDidLoad {
    ...
    self.limitIndex = 1;
    self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/topic/list/chuanyue/31/bs0315-iphone-4.3/0-%ld.json",self.limitIndex * 40];
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/topic/list/chuanyue/31/bs0315-iphone-4.3/0-%ld.json",(self.limitIndex + 1) * 40];
        self.limitIndex += 1;
        [self.topicFrame removeAllObjects];
        // 请求数据
        [self requestData];
...
{
    if (!_imageView) {
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(kScreenWidth-KNaviH*1.5, 20, KNaviH, KNaviH)];
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(pushPlayerViewController)];
