//
//  CrossTextTableViewController.m
//  Product-B
//
...
@interface CrossTextTableViewController ()
...
@implementation CrossTextTableViewController
...
- (void)viewDidLoad {
    ...
    self.limitIndex = 1;
    self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/topic/list/chuanyue/29/bs0315-iphone-4.3/0-%ld.json",self.limitIndex * 40];
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        self.Url =[NSString stringWithFormat:@"http://d.api.budejie.com/topic/list/chuanyue/29/bs0315-iphone-4.3/0-%ld.json",(self.limitIndex + 1) * 40];
        self.limitIndex += 1;
        [self.topicFrame removeAllObjects];
        // 请求数据
        [self requestData];
